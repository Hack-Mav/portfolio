...
test.describe('Portfolio E2E Tests', () => {
  ...
  test.describe('Home Page', () => {
    ...
    test('should support dark mode toggle', async ({ page }) => {
      ...
      const darkModeToggle = page.locator('[aria-label*="dark"], [aria-label*="light"]').first();
  ...
  test.describe('Projects Page', () => {
    ...
    test('should filter projects', async ({ page }) => {
      ...
      if (await filterButton.isVisible()) {
        ...
        // Test filter options
        const filterOptions = page.locator('[role="menuitem"], [data-testid="filter-option"]');
  ...
  test.describe('Contact Page', () => {
    ...
    test('should display contact information', async ({ page }) => {
      ...
      const locationInfo = page.locator('[data-testid="location"], [aria-label*="location"]');
  ...
  test.describe('About Page', () => {
    ...
    test('should display about information', async ({ page }) => {
      ...
      const skillsSection = page.locator('[data-testid="skills"], h2:has-text("Skills")');
      if (await skillsSection.isVisible()) {
        await expect(skillsSection).toBeVisible();
      }
      
      // Look for experience section
      const experienceSection = page.locator('[data-testid="experience"], h2:has-text("Experience")');
    ...
    test('should display resume download link', async ({ page }) => {
      const resumeLink = page.locator('a[href*="resume"], a[href*="Resume"], [data-testid="resume-link"]');
    ...
    test('should show skill progress bars or indicators', async ({ page }) => {
      const skillElements = page.locator('[data-testid="skill"], [role="progressbar"], .skill-item');
  ...
  test.describe('Error Handling', () => {
    test('should handle 404 pages gracefully', async ({ page }) => {
      ...
      const is404Page = await page.locator('h1:has-text("404"), h1:has-text("Not Found")').isVisible();
      const isHomePage = await page.locator('h1:has-text("Home"), h1:has-text("Portfolio")').isVisible();
